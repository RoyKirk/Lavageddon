...
Shader "Shader Forge/NewShader" {
    Properties {
        ...
        _heightmultiply ("height multiply", Float ) = 0.07
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_2018 = (o.uv0+node_2245.r*float2(0.1,0.2));
                ...
                float2 node_1594 = (o.uv0+node_7058.r*float2(0.3,0.3));
                ...
                v.vertex.xyz += (lerp(node_7604,dot(node_7604,float3(0.3,0.59,0.11)),1.0)*_heightmultiply*v.normal);
